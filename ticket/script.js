...
$btnImprimir.addEventListener("click", () => {
    ...
    conector.text("Parzibyte's blog\n");
    conector.text("Blog de un programador\n");
    conector.text("Telefono: 123456789\n");
    conector.text("Fecha/Hora: 2021-02-08 16:57:55\n");
    conector.text("--------------------------------\n");
    conector.text("Venta de plugin para impresora\n");
    conector.establecerJustificacion(ConectorPlugin.Constantes.AlineacionDerecha);
    conector.text("25 USD\n");
    conector.text("--------------------------------\n");
    conector.text("TOTAL: 25 USD\n");
    conector.text("--------------------------------\n");
    conector.establecerJustificacion(ConectorPlugin.Constantes.AlineacionCentro);
